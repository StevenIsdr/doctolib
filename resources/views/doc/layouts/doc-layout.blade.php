        ...
        <div :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
            ...
            <nav class="flex flex-col  w-auto px-7 pt-4 pb-6">
                ...
                <ul class="mt-2">
                    <!-- Links -->
                    <li class="mt-8">
                        <a href="/tableau-de-bord/horaires" class="flex items-center shadow px-3 py-2 rounded-lg @if(request()->path() == "tableau-de-bord/horaires") bg-cyan-600 text-white @else hover:scale-105 transition hover:bg-cyan-600 hover:text-white @endif">
                            <svg
